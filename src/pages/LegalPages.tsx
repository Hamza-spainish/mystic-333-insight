...
export const TermsAndConditions = () => (
  <LegalLayout title="Terms & Conditions" metaTitle="Terms & Conditions - Angel Number 333" metaDescription="Terms and conditions for using theangelnumber333.com.">
    <p>Last updated: February 22, 2026</p>
...
export const Disclaimer = () => (
  <LegalLayout title="Disclaimer" metaTitle="Disclaimer - Angel Number 333" metaDescription="Important disclaimer for theangelnumber333.com content and services.">
    <p>Last updated: February 22, 2026</p>
...
export const CookiePolicy = () => (
  <LegalLayout title="Cookie Policy" metaTitle="Cookie Policy - Angel Number 333" metaDescription="Cookie policy for theangelnumber333.com explaining how we use cookies and tracking technologies.">
    <p>Last updated: February 22, 2026</p>
...
export const AffiliateDisclosure = () => (
  <LegalLayout title="Affiliate Disclosure" metaTitle="Affiliate Disclosure - Angel Number 333" metaDescription="Affiliate disclosure for theangelnumber333.com explaining our affiliate relationships and compensation.">
    <p>Last updated: February 22, 2026</p>
